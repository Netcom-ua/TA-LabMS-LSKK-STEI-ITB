...
<head>
<meta charset="utf-8">
<title>Teknisi | Lab Management System</title>
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="home"><img src="../img/<?php echo $info['logo'];?>" alt=""></a>
      <div class="nav-collapse">
        <ul class="nav pull-right">
		  <?php 	
			$nip_staf = $_SESSION['nip_staf'];
		 ...
		 ?>
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
            ...
            <ul class="dropdown-menu">
			  <li><a href="javascript:;"><img src="../staf/foto_staf/<?php echo $data['foto']?>" width=100 height=100 title="<?php echo $data['nama']?>"></a></li>
  ...
  <div class="subnavbar-inner">
    <div class="container">
       <ul class="mainnav">
        ...
        <li><a href="tampil_peminjam.html"><i class="icon-tags"></i><span>Informasi Peminjaman</span> </a> </li>
